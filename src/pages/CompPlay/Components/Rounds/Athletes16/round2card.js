...
const Round2CardAthlets16 = ({data, callback}) => {
  ...
  return (
    <div className='border-2 p-1 justify-between flex-col w-60 mt-1'>
        <div className='flex justify-between items-center'>
           ...
           <div onClick={() => Submit({winner:data.athlete1, lose:data.athlete2 , aths:16})}>
        ...
        <div className='flex justify-between items-center'>
            ...
            <div onClick={() => Submit({winner:data.athlete2, lose:data.athlete1, aths:16})}>
             <img className='h-5 rounded-full bg-gray-200 p-1 hover:bg-gray-300 cursor-pointer' src='../../icons/check.png'/>
            </div>
        </div>
    </div>
...
export default Round2CardAthlets16
