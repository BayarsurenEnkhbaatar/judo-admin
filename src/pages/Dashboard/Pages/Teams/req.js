...
const TeamsReq = () => {
  ...
  const [pagination, setPagination] = useState({limit:5, all:'', totalPage:'', status:STATUS.REQUESTED, username:''});
                ...
                <table className="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-700">
                  ...
                  </thead>
                  {
                    ...
                    <tbody className="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                      {
                        data.map((item, index) => {
                          {/* const res = IMAGE_GET({key:item.profile_img}); */}
